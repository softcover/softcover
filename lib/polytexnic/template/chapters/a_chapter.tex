...
You can indicate inline code using the \verb+\kode+ command, as in \kode{current\_\-user}. If you prefer a plainer version of the same thing, you can use ``typewriter text'', as in \texttt{current\_\-user}.
...
To make a tabular environment into a full-blown table, with a number and a caption, you use the \kode{table} environment (Table~\ref{table:rails_actions}).
